...
// Query
$query = "SELECT numbering, coursetitle, instructor FROM Course WHERE numbering in (select CourseNumbering from Take group by CourseNumbering having count(*) >= $num)";
$result = mysqli_query($dbcon, $query)
  or die('Query failed: ' . mysqli_error($dbcon));

//check result and show result
$count = mysqli_num_rows($result);
print "There are $count courses that at least $num students take.";
